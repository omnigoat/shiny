...
application_t::application_t()
	...
	, window(fooey::window("Excitement!", 1024, 1024))
	, runtime{}
{
	function_main();
	...
	ib_cube = shiny::create_index_buffer(ctx, shiny::resource_storage_t::immutable, shiny::index_format_t::index16, 36, cube_indices);
