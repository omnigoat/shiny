...
using dust::geometry_shader_t;


auto dust::create_geometry_shader(context_ptr const& context, atma::unique_memory_t const& memory, bool precompiled, atma::string const& entrypoint) -> geometry_shader_ptr
{
