...
auto dust::create_vertex_shader(context_ptr const& context, vertex_declaration_t const* vd, atma::unique_memory_t const& memory, bool precompiled, atma::string const& entrypoint) -> vertex_shader_ptr
{
