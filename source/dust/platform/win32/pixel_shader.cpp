...
: context_(ctx)
{
	...
	else
	{
		...
		ATMA_ENSURE_IS(S_OK, D3DCompile(data, data_length, nullptr, nullptr, nullptr, entrypoint.bytes_begin(), "ps_5_0", D3DCOMPILE_DEBUG, 0, d3d_blob_.assign(), errors.assign()));
		if (errors.get())
		{
