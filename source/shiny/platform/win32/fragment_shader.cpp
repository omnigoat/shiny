...
: context_(ctx)
{
	...
	else
	{
		...
		ATMA_ENSURE_IS(S_OK, D3DCompile(data, data_length, nullptr, nullptr, D3D_COMPILE_STANDARD_FILE_INCLUDE, entrypoint.raw_begin(), "ps_5_0", D3DCOMPILE_PREFER_FLOW_CONTROL | D3DCOMPILE_DEBUG | D3DCOMPILE_SKIP_OPTIMIZATION, 0, d3d_blob_.assign(), errors.assign()));
		if (errors.get())
		{
