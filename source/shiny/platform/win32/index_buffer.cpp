...
index_buffer_t::index_buffer_t(renderer_ptr const& context, resource_storage_t usage, format_t format, uint index_count, void const* data, uint data_indexcount)
