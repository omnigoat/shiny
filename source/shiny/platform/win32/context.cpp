...
auto context_t::make_generic_buffer(resource_usage_flags_t const& rs, buffer_usage_t bu, size_t stride, uint elements, void const* data, uint data_elemcount) -> generic_buffer_ptr
{
