...
generic_buffer_t::generic_buffer_t(renderer_ptr const& ctx, resource_usage_mask_t const& rs, resource_storage_t usage, size_t stride, uint elements, void const* data, uint data_elemcount)
