...
vertex_buffer_t::vertex_buffer_t(renderer_ptr const& context, resource_storage_t usage, data_declaration_t const* vd, uint vertex_count, void const* data, uint data_vertcount)
	: buffer_t(context,
