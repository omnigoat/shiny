...
namespace dust
{
	...
	{
		friend auto create_vertex_shader(context_ptr const&, atma::unique_memory_t const&, bool precompiled, atma::string const& entrypoint = "main") -> vertex_shader_ptr;
	...
	protected:
		vertex_shader_t(context_ptr const&, void const* data, size_t data_length, bool precompiled, atma::string const&);
