...
namespace shiny
{
	...
	template <typename... Args>
	inline auto signal_draw(renderer_ptr const& ctx, atma::thread::engine_t::queue_t::batch_t& batch, Args&&... args) -> void
	{
	...
	template <typename... Args>
	inline auto signal_draw(renderer_ptr const& ctx, Args&&... args) -> void
	{
